...
public class SLoginWebQryWSStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"SLoginWebQryWS" + getUniqueSuffix());
	 ...
	 */
	public SLoginWebQryWSStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					com.sitech.esb.txdows.SLoginWebQryWSStub.CallServiceResponse.class,
	...
	// tcp://10.110.0.206:52000/esbWS/services/sLoginWebQryWS
	public static class SrvReturnBean implements
		...
		public void addRetMatrix(TxdoBuf param) {
			...
			java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
					.toList(localRetMatrix);
			list.add(param);
			this.localRetMatrix = (TxdoBuf[]) list.toArray(new TxdoBuf[list
					.size()]);
		...
		public void serialize(
			...
			if (serializeType) {
				...
				java.lang.String namespacePrefix = registerPrefix(xmlWriter,
						"http://ws.esb.sitech.com/xsd");
				if ((namespacePrefix != null)
						&& (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":SrvReturnBean",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "SrvReturnBean", xmlWriter);
				}
			...
			if (localEsbRetCodeTracker) {
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter.writeStartElement(prefix, "esbRetCode",
								namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
				...
				if (localEsbRetCode == java.lang.Integer.MIN_VALUE) {
					...
					throw new org.apache.axis2.databinding.ADBException(
							"esbRetCode cannot be null!!");

				} else {
					xmlWriter
							.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localEsbRetCode));
				}
			...
			if (localRetCodeTracker) {
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter.writeStartElement(prefix, "retCode",
								namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
				...
				if (localRetMatrix != null) {
					for (int i = 0; i < localRetMatrix.length; i++) {
						if (localRetMatrix[i] != null) {
							localRetMatrix[i].serialize(
									new javax.xml.namespace.QName(
											"http://ws.esb.sitech.com/xsd",
											"retMatrix"), factory, xmlWriter);
						} else {
					...
					if (!namespace2.equals("")) {
						...
						if (prefix2 == null) {
							...
							xmlWriter.writeStartElement(prefix2, "retMatrix",
									namespace2);
							...
							xmlWriter
									.writeStartElement(namespace2, "retMatrix");
						}
			...
			if (localRetMsgTracker) {
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter
								.writeStartElement(prefix, "retMsg", namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localEsbRetCodeTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://ws.esb.sitech.com/xsd", "esbRetCode"));
			...
			if (localRetCodeTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://ws.esb.sitech.com/xsd", "retCode"));

				elementList.add(localRetCode == null ? null
						: org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localRetCode));
			}
			if (localRetMatrixTracker) {
				if (localRetMatrix != null) {
					for (int i = 0; i < localRetMatrix.length; i++) {
					...
					elementList.add(new javax.xml.namespace.QName(
							"http://ws.esb.sitech.com/xsd", "retMatrix"));
			...
			if (localRetMsgTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://ws.esb.sitech.com/xsd", "retMsg"));

				elementList.add(localRetMsg == null ? null
						: org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localRetMsg));
			}
		...
		public static class Factory {
			 ...
			 */
			public static SrvReturnBean parse(
					javax.xml.stream.XMLStreamReader reader)
				...
				try {
							...
							if (!"SrvReturnBean".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (SrvReturnBean) ExtensionMapper
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName(
									"http://ws.esb.sitech.com/xsd",
									"esbRetCode").equals(reader.getName())) {

						java.lang.String content = reader.getElementText();

						object
								.setEsbRetCode(org.apache.axis2.databinding.utils.ConverterUtil
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object
									.setRetCode(org.apache.axis2.databinding.utils.ConverterUtil
					...
					if (reader.isStartElement()
						...
						while (!loopDone3) {
							...
							if (reader.isEndElement()) {
								...
								if (new javax.xml.namespace.QName(
										"http://ws.esb.sitech.com/xsd",
										"retMatrix").equals(reader.getName())) {
						...
						object
								.setRetMatrix((TxdoBuf[]) org.apache.axis2.databinding.utils.ConverterUtil
										.convertToArray(TxdoBuf.class, list3));
					...
					if (reader.isStartElement()
						...
						if (!"true".equals(nillableValue)
							...
							object
									.setRetMsg(org.apache.axis2.databinding.utils.ConverterUtil
											.convertToString(content));
	...
	public static class CallServiceResponse implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://txdoWS.esb.sitech.com", "callServiceResponse", "ns2");
			...
			if (local_returnTracker) {
				if (local_return == null) {
					...
					local_return.serialize(new javax.xml.namespace.QName(
							"http://txdoWS.esb.sitech.com", "return"), factory,
							xmlWriter);
				}
			}
			xmlWriter.writeEndElement();
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (local_returnTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://txdoWS.esb.sitech.com", "return"));
				...
				try {
					...
					if (reader.isStartElement()
						...
						if ("true".equals(nillableValue)
							...
							object.set_return(SrvReturnBean.Factory
									.parse(reader));
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://ws.esb.sitech.com/xsd".equals(namespaceURI)
					&& "SrvReturnBean".equals(typeName)) {
	...
	public static class CallService implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://txdoWS.esb.sitech.com", "callService", "ns2");
		...
		public void addParams(java.lang.String param) {
			...
			java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
					.toList(localParams);
			list.add(param);
			this.localParams = (java.lang.String[]) list
				...
				if (localParams != null) {
					...
					if (!namespace2.equals("")) {
						...
						if (prefix2 == null) {
							...
							xmlWriter.writeStartElement(prefix2, "params",
									namespace2);
							xmlWriter.writeNamespace(prefix2, namespace2);
							xmlWriter.setPrefix(prefix2, namespace2);
			...
			if (localParamsTracker) {
				if (localParams != null) {
					for (int i = 0; i < localParams.length; i++) {
						...
						if (localParams[i] != null) {
							elementList.add(new javax.xml.namespace.QName(
									"http://txdoWS.esb.sitech.com", "params"));
							elementList
									.add(org.apache.axis2.databinding.utils.ConverterUtil
											.convertToString(localParams[i]));
						} else {
			...
			public static CallService parse(
				...
				try {
					...
					if (reader.isStartElement()
						...
						object.setParams((java.lang.String[]) list1
	...
	public static class TxdoBuf implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * TxdoBuf Namespace URI = http://ws.esb.sitech.com/xsd Namespace Prefix =
		 * ns1
		 */
		...
		public void addBuffer(java.lang.String param) {
			...
			java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
					.toList(localBuffer);
			list.add(param);
			this.localBuffer = (java.lang.String[]) list
					.toArray(new java.lang.String[list.size()]);
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":TxdoBuf", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "TxdoBuf", xmlWriter);
				}
				...
				if (localBuffer != null) {
					...
					if (!namespace2.equals("")) {
						...
						if (prefix2 == null) {
							...
							xmlWriter.writeStartElement(prefix2, "buffer",
									namespace2);
							xmlWriter.writeNamespace(prefix2, namespace2);
							xmlWriter.setPrefix(prefix2, namespace2);
			...
			if (localBufferTracker) {
				if (localBuffer != null) {
					for (int i = 0; i < localBuffer.length; i++) {
						...
						if (localBuffer[i] != null) {
							elementList.add(new javax.xml.namespace.QName(
									"http://ws.esb.sitech.com/xsd", "buffer"));
							elementList
									.add(org.apache.axis2.databinding.utils.ConverterUtil
											.convertToString(localBuffer[i]));
						} else {
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static TxdoBuf parse(javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"TxdoBuf".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (TxdoBuf) ExtensionMapper.getTypeObject(
										nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						object.setBuffer((java.lang.String[]) list1
								.toArray(new java.lang.String[list1.size()]));
	...
	private org.apache.axiom.om.OMElement toOM(
			com.sitech.esb.txdows.SLoginWebQryWSStub.CallService param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							com.sitech.esb.txdows.SLoginWebQryWSStub.CallService.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			com.sitech.esb.txdows.SLoginWebQryWSStub.CallServiceResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							com.sitech.esb.txdows.SLoginWebQryWSStub.CallServiceResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (com.sitech.esb.txdows.SLoginWebQryWSStub.CallService.class
					.equals(type)) {

				return com.sitech.esb.txdows.SLoginWebQryWSStub.CallService.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (com.sitech.esb.txdows.SLoginWebQryWSStub.CallServiceResponse.class
					.equals(type)) {

				return com.sitech.esb.txdows.SLoginWebQryWSStub.CallServiceResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
