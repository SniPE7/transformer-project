...
@XmlRootElement(name = "AskMatch2")
public class AskMatch2 {

    @XmlElementRef(name = "n1", namespace = "http://Hirsch.Match.Code", type = JAXBElement.class)
    ...
    public void setN1(JAXBElement<String> value) {
        this.n1 = ((JAXBElement<String> ) value);
    }
