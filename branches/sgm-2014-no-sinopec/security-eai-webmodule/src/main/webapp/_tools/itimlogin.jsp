...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
            ...
            <div id="acloginpanel" class="loginpanel">
              <form class="aui cmxform" method="post" id="authenForm"
                ...
                <fieldset>
                  ...
                  <input type="text" tabindex="1" name="username" id="j_username" class="textinput" />
                  <label class="float-left"><spring:message code="logon.form.password" /></label>
                  <input type="password" tabindex="2" name="password" id="j_password" class="textinput"/>
                  <div class="aclogin-action">
                    <div class="fl-left">
                      ...
                      <div id="forgotbox">
                        <a tabindex="5" href="<%=request.getContextPath()%>/help/getlostpassword.mt"
                    ...
                    <input type="image" tabindex="7" title="登录" alt=" "
                      src="<%=request.getContextPath()%>/images/login/transparent.gif" class="acloginbttn">
        ...
        <script>setMsg('info','<spring:message code="login.form.error.title.tim" />');</script>