...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
        ...
        <script>setMsg('info','<spring:message code="login.form.error.title.pwd" />');</script>