...
public class Parameters extends Ordinal {
     ...
     */
    public static final Parameters ConnectionImplClass = new Parameters("ConnectionImplClas", String.class, "org.jdiameter.client.impl.transport.tcp.SecureClientConnection");
