...
<div id="login_successfull">
	<div id="brand"><a href="./service/authen/logout">退出</a></div>
	<div id="welcome">
	亲爱的 <c:out value="${sessionScope.SESSION_PERSON.commonName}"/><br>
	(<a href="javascript:void()"><c:out value="${sessionScope.username}"/> 黑龙江</a>) 您好</div>
	<hr>
	<div id="main">
	  <ul id="MainNav">
