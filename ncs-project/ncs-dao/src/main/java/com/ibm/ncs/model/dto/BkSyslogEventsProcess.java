...
public class BkSyslogEventsProcess implements Serializable
{
	/** 
	 * This attribute maps to the column BK_ID in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected long bkId;

	/** 
	 * This attribute maps to the column BK_TIME in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected Date bkTime;

	/** 
	 * This attribute maps to the column MARK in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String mark;

	/** 
	 * This attribute maps to the column VARLIST in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String varlist;

	/** 
	 * This attribute maps to the column BTIMELIST in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String btimelist;

	/** 
	 * This attribute maps to the column ETIMELIST in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String etimelist;

	/** 
	 * This attribute maps to the column FILTERFLAG1 in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column FILTERFLAG2 in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY1 in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY2 in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column PORT in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String port;

	/** 
	 * This attribute maps to the column NOTCAREFLAG in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column TYPE in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected long type;
	...
	/** 
	 * This attribute maps to the column EVENTTYPE in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column SUBEVENTTYPE in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column ALERTGROUP in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String alertgroup;

	/** 
	 * This attribute maps to the column ALERTKEY in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String alertkey;

	/** 
	 * This attribute maps to the column SUMMARYCN in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String summarycn;

	/** 
	 * This attribute maps to the column PROCESSSUGGEST in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String processsuggest;

	/** 
	 * This attribute maps to the column STATUS in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String status;

	/** 
	 * This attribute maps to the column ATTENTIONFLAG in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	...
	/** 
	 * This attribute maps to the column EVENTS in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String events;

	/** 
	 * This attribute maps to the column MANUFACTURE in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String manufacture;

	/** 
	 * This attribute maps to the column ORIGEVENT in the BK_SYSLOG_EVENTS_PROCESS table.
	 */
	protected String origevent;

	/**
	 * Method 'BkSyslogEventsProcess'
	 * 
	 */
	public BkSyslogEventsProcess()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BkSyslogEventsProcess)) {
			return false;
		}
		
		final BkSyslogEventsProcess _cast = (BkSyslogEventsProcess) _other;
		if (bkId != _cast.bkId) {
			return false;
		}
	 ...
	 */
	public BkSyslogEventsProcessPk createPk()
	{
		return new BkSyslogEventsProcessPk(bkId);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.BkSyslogEventsProcess: " );
