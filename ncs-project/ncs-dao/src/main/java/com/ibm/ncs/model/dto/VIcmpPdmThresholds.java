...
public class VIcmpPdmThresholds implements Serializable
{
	/** 
	 * This attribute maps to the column DEVIP in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String devip;

	/** 
	 * This attribute maps to the column OIDNAME in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String oidname;

	/** 
	 * This attribute maps to the column BTIME in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String btime;

	/** 
	 * This attribute maps to the column ETIME in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String etime;

	/** 
	 * This attribute maps to the column VALUE0 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String value0;

	/** 
	 * This attribute maps to the column VALUE_1 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String value1;

	/** 
	 * This attribute maps to the column VALUE_2 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String value2;

	/** 
	 * This attribute maps to the column VAR0 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String var0;

	/** 
	 * This attribute maps to the column VALUE_1_LOW in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String value1Low;

	/** 
	 * This attribute maps to the column VALUE_2_LOW in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String value2Low;

	/** 
	 * This attribute maps to the column COMPARETYPE in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String comparetype;

	/** 
	 * This attribute maps to the column V1L_SEVERITY_1 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY_1 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY_2 in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column V1L_SEVERITY_A in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY_A in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY_B in the V_ICMP_PDM_THRESHOLDS table.
	 */
	...
	/** 
	 * This attribute maps to the column FILTER_A in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String filterA;

	/** 
	 * This attribute maps to the column FILTER_B in the V_ICMP_PDM_THRESHOLDS table.
	 */
	protected String filterB;

	/**
	 * Method 'VIcmpPdmThresholds'
	 * 
	 */
	public VIcmpPdmThresholds()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof VIcmpPdmThresholds)) {
			return false;
		}
		
		final VIcmpPdmThresholds _cast = (VIcmpPdmThresholds) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.VIcmpPdmThresholds: " );
