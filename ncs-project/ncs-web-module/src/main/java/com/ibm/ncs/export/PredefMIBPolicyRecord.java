...
public class PredefMIBPolicyRecord {
  ...
  public void toSnmpXML(PrintWriter output, String snmpPort, String serverID) {
    ...
    output.println("    <element active=\"true\" checksum=\"zeit_" + ipID + "_" + Math.abs(this.hashCode()) + "\" datalogpath=\"" + this.getModuleName() + this.getDevip() + "_" + this.getOidGroupName() + "_" + this.getOidindex() + "_" + snmpPort + "\" profile=\"" + serverID + "_" + this.getModuleName() + "_" + this.getEventTypeMajor() + "\">");
    output.println("      <fields>");
    output.println("        <server>" + this.getDevip() + "</server>");
    output.println("        <oidgroupname>" + this.getOidGroupName() + "_" + this.getOidindex() + "</oidgroupname>");
    ...
    output.println("        <description>" + serverID + " " + this.getSysname() + " " + this.getEventTypeMajor() + " PortName:" + this.getOidname() + " LineName:NA</description>");
    output.println("      </fields>");
  ...
  public void toIcmpXML(PrintWriter output, String serverID) {
    ...
    output.println("    <element active=\"true\" checksum=\"zeit_" + ipID + "_" + Math.abs(this.hashCode()) + "\" datalogpath=\"" + this.getModuleName() + this.getDevip() + "\" profile=\"" + serverID + "_" + this.getModuleName() + "_Ports\">");
    output.println("      <fields>");
    output.println("        <server>" + this.getDevip() + "</server>");
