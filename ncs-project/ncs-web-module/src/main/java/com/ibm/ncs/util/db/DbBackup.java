...
public class DbBackup {
	...
	//System.out.println("tables="+tables);
	        ...
	        for(int i=0;i<tables.size();i++){
	        	...
	        	if (tableName.contains("_TMP")) continue;
	        	if (tableName.contains("CFG")) continue;
	      ...
	      try
	        {
	            ...
	            sbuf.append("create sequence NM_SEQ minvalue 1 maxvalue 99999999999 start with ")
	                .append(maxSeq).append(" increment by 1 nocache cycle").append("\n");
	            //
	            maxSeq = 0L;
	            ...
	            sbuf.append("create sequence TASK_SEQ minvalue 1 maxvalue 99999999999 start with ")
	                .append(maxSeq).append(" increment by 1 nocache cycle").append("\n");
	        }
	        catch(Exception e)
	        {
