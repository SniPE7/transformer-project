...
public class DeleteDeviceSnmpParamGroupsController extends SimpleFormController implements Controller {
	...
	//	String[] eveidstr = request.getParameterValues("eveid");
		...
		System.out.println("eveid is "+eveidstr+" modid is "+modidstr);
	...
	//	}
		...
		if(returntojsp == true){
			message = "<script language='javascript'>alert('该设备性能指标定制了策略，不能删除！');</script>";
