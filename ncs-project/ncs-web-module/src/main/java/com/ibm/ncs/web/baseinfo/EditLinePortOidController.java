...
public class EditLinePortOidController implements Controller {
...
//		System.out.println("OPID:"+opidStr+"********");
...
//			System.out.print(oidgroupname +"  ... ");
//			System.out.println(pmppara +" , "+ pmpmanu+" , "+pmptail);
