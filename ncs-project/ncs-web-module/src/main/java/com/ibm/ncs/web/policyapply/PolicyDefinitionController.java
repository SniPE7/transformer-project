...
//			System.out.println("request string as:cate="+cate+" : mpid="+mpid+" : mpname"+mpname);
			...
			try{
				...
				//		System.out.println("policys is null ? "+(policys == null));
						...
						model.put("mpid", null);
						model.put("refresh", "true");
					}else if(formAction.equalsIgnoreCase("save") && mpid!=null){		//update; tested
						...
						//policybase2 = TPolicyBaseDao.findWhereMpnameEquals(mpname)==null?null:TPolicyBaseDao.findWhereMpnameEquals(mpname).get(0);
