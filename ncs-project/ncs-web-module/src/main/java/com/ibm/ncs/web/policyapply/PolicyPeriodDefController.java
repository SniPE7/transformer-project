 ...
 *
 */
public class PolicyPeriodDefController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try{
			...
			TPolicyPeriod policyperiod = TPolicyPeriodDao.findByPrimaryKey(ppid);		
			
			bean =bean.	beanTransfer(policyperiod);
		...
		return new ModelAndView("/secure/policyapply/policyPeriodDef.jsp", "model",model);
		//return new ModelAndView("/secure/policyapply/policyPeriodDef.jsp", "policyperiod",bean);
	}
