...
public class EditServerInfoPreController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try{
		   ...
		   //TServerInfo serverinfo = TServerInfoDao.findWhereNmsnameEquals(request.getParameter("nmsname"));
			TServerInfo server = TServerInfoDao.findByPrimaryKey(Long.parseLong(request.getParameter("nmsid")));
			
			System.out.println("the serverinfo is --------"+serverinfo);
