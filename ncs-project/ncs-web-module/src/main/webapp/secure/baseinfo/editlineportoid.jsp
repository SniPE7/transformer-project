  ...
  formm.oidunit.value='';
    ...
    function saveoidgroup(){
      ...
      if(saveflag == "yes"){
        ...
        formm.action="<%=request.getContextPath() %>/secure/baseinfo/savelineportoid.wss";
        formm.submit();
      }
...
function deleteoiddetails(){
   ...
   return ;
      ...
      if(confirm('确定删除所选OID?')){
         formm.action="<%=request.getContextPath() %>/secure/baseinfo/deletelineportoiddetails.wss";
         formm.submit();
       }
    }
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">更新线路/端口OID Group</h1>
        <p ></p>
     ...
     <input type="hidden" name="formAction" value="jDBCProviderCollection.do"/>  
		...
		<table  cellspacing="1" cellpadding="3" border="0" width="100%" class="framing-table">
			...
			<tr class="table-row">
					...
					<td  class="tdcontent">
					 <select name="performanceparaselect" onChange="changeperfsel()" id="formStyleblock1">
		...
		<table class="framing-table" border="0" bordercolor="#999999" cellpadding="3" cellspacing="1" width="100%">
			...
			<c:forEach items="${model.details}" var="theO" >
				<tr class="table-row">
                    ...
                    &nbsp;
					<a href="<%=request.getContextPath()%>/secure/baseinfo/deletelineportoiddetails.wss?opid=${theO.opid }&oidname=${theO.oidname }&oidunit=${theO.oidunit }&oidindex=${theO.oidindex }" onclick="return confirm('确定删除信息?');"><img border="0" src="../../images/delete.gif" width="16" height="16" alt="删除"></a> </td>
