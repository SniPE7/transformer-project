...
function changemfsel(){
	formm.pmppara.value = formm.performanceselect.value;
	form.pmpmanu.value =  formm.manufselect.value ;
	alert('mf='+devoid.performanceselect.value);
}
...
function savedetails(){
  ...
  if(formm.checkbps.checked&&formm.oidunit.value!='BPS'){
   ...
   if(formm.oidname.value==''||formm.oidvalue.value==''||formm.oidunit.value==''){
     alert('必填项不能为空!');
     return ;
   }
   if(!checkobject()){
  ...
  formm.oidunit.value='';
    ...
    function saveoidgroup(){
      ...
      if(confirm('确定保存该oidgroup?')){
        formm.action="<%=request.getContextPath() %>/secure/baseinfo/savenewdevoid.wss";
        formm.submit();
      }
...
<body>
  ...
  <TABLE WIDTH="98%" CELLPADDING="0" CELLSPACING="0" BORDER="0" class="portalPage">
      <TR>
          <TD CLASS="pageTitle">新建设备OID Group</TD>
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TR>
      <TH class="wpsPortletTitle" width="100%">新建设备OID Group</TH>
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">新建设备OID Group</h1>
        <p ></p>
<form action="<%=request.getContextPath() %>/secure/resourceman/newdevoid.wss" method="post" name="formm" >
<a name="main"></a>
<!-- button section -->
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <input type="hidden" name="buttonperspective" value="null"/> 
     <input type="hidden" name="formAction" value="jDBCProviderCollection.do"/>  
		...
		<!--<div class="wasPortlet" value="details">OID Group修改</div>-->
		<div class="wasPortlet">
		<table  cellspacing="1" cellpadding="0" border="0" width="100%" class="framing-table">

			<tr  >
					<td width="20%"  >OID Group类别</td>
			...
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OID Group
				    名称
					  <input type="hidden" name="opid" value="${model.dto.opid}" class="formStyleblock"></td>
					<td  >
					<input type="text" name="pmppara" readonly value="${pmppara }">&nbsp;_&nbsp;
					<input type="text" name="pmpmanu" readonly value="${pmpmanu }">&nbsp;_&nbsp;
					<input type="text" name="pmptail" value="${pmptail}" class="formStyleblock">&nbsp;</td>
			</tr>
			<tr class="table-row" >

					<td width="20%"  class="tdlabel">&nbsp;</td>
					<td  ><input type="button" value="保存"  onclick="saveoidgroup()">&nbsp;<input type="hidden" name="oidgroupname" value="${model.dto.oidgroupname }"></td>
			</tr>
			
		</table>
		</div>
		
		<div class="wasPortlet">OID	
		<table cellspacing="1" cellpadding="0" border="0" width="100%" VALIGN="top" class="collection-table-text">
			...
			<tr class="table-row" >
					...
					<td  class="tdcontent"><input type="text" name="oidvalue" value="" class="formStyleblock">* 必填</td>
			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OID名称<input type="hidden" name="yuanoidname" value="" class="formStyleblock"></td>
					<td  class="tdcontent"><input type="text" name="oidname" value="" class="formStyleblock">* 必填</td>

			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OID单位</td>
					<td  class="tdcontent"><input type="text" name="oidunit" value="" class="formStyleblock">* 必填</td>
			</tr>
			<tr class="table-row"  >
					<td width="20%"  class="tdlabel">Index</td>

					<td  class="tdcontent"><input type="text" name="oidindex" value="" class="formStyleblock">* 必填&nbsp;</td>
			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">&nbsp;</td>
					<td  class="tdcontent"><input type="checkbox" name="checkbps" value="0">if the Unit as "BPS"</td>
			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">&nbsp;</td>

					<td  class="tdcontent"><input type="checkbox" name="flag" value="0">Check to combind oid and index</td>
			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">&nbsp;</td>
					<td  class="tdcontent"><input type="button" name="new" value="新建" id="buttonStyle1" onClick="clearfornew()">
					<input type="button" value="保存" onClick="savedetails()" id="buttonStyle1"></td>
			</tr>
		</table>
        </div>
		
		<div class="sectionHeading" value="Details">OID </div>
		<div class="framing-table">
		
		<table  cellspacing="1" cellpadding="0"
			border="0" width="100%" class="wasPortlet">
			<tr valign="top" >
								<th nowrap="nowrap"><input type="checkbox" onClick="checkall(this,'oiddids')"></th>
								<th nowrap="nowrap">序号</th>
								<th nowrap="nowrap">OID值</th>

								<th nowrap="nowrap">OID名称</th>
								<th nowrap="nowrap">OID单位</th>
								<th nowrap="nowrap">添加端口Index</th>
			</tr>
			<c:forEach items="${model.details}" var="theO" >
				<tr class="table-row" onClick="showoid('${theO.opid}','${theO.oidname}', '${theO.oidindex}','${theO.oidvalue}','${theO.oidname}','${theO.oidunit}','${theO.flag}' );">
					<td nowrap="nowrap"><input type="checkbox" id="oiddids" name="oiddetailsid" value="DEVICENAME" /> </td>
					<td nowrap="nowrap">${theO.opid }&nbsp;</td>
			...
			<tr valign="top">
								<th nowrap="nowrap"><input type="button" name="" value="删除" onClick="deleteoiddetails()" id="buttonStyle1"></th>
								<th nowrap="nowrap">&nbsp;</th>
								<th nowrap="nowrap">&nbsp;</th>
								<th nowrap="nowrap">&nbsp;</th>
								<th nowrap="nowrap">&nbsp;</th>
...
<tr>
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="mrname"><input
											type="checkbox" name="chkbox"></th>
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="category">OID名称</th>
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="subcategory"></th>
</tr>

<c:forEach items="${model.devicelist}" var="c1" >
<tr class="table-row">
<td VALIGN="top"  class="collection-table-text" headers="mrname"><input type="checkbox" name="delsel"> </td>
<td VALIGN="top"  class="collection-table-text" headers="catename"> </td>
