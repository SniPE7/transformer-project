...
<html>
<head>
<title>Line / Port OID Groups</title>
...
function addform1(){
lineportoid.formAction.value= 'add';

lineportoid.action = "<%=request.getContextPath() %>/secure/baseinfo/newlineportoid.wss";
 }
function deleteform1(){
	lineportoid.formAction.value= 'delete';
    var v = confirm('确定删除信息?');
	if( ! v ){ return false;	}
	if(v){
	lineportoid.action = "<%=request.getContextPath() %>/secure/baseinfo/deletelineportoidoid.wss";
	this.lineportoid.submit();
	}
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">线路 / 端口OID Groups</h1>
        <p ></p>
<form action="" method="post" name="lineportoid" >
<a name="main"></a>
<!-- button section -->
...
<th NOWRAP VALIGN="BOTTOM" class="table-sortable:default column-head-name" SCOPE="col" >OID 名称&nbsp;
  <input name="filter" size="15" onkeyup="Table.filter(this,this)"></th>
</tr>
</thead>
...
<a href="<%=request.getContextPath() %>/secure/baseinfo/editlineportoid.wss?opid=${c1.opid }" >
<img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16"></a>
&nbsp;&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deletelineportoidoid.wss?opid=${c1.opid }" onclick="return confirm('确定删除信息?');">
			<img border="0" src="../../images/delete.gif" width="16" height="16" alt="删除"></a>
</td>
<td VALIGN="top"  class="collection-table-text" headers="catename">${c1.oidgroupname } </td>
