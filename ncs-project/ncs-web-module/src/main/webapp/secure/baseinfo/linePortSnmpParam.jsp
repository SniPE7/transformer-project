...
function addform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/baseinfo/newLinePortSnmpParam.jsp";
	this.form1.submit();
}
function deleteform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/baseinfo/deleteLinePortSnmpParam.wss";
	this.form1.submit();
}
function updateform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/baseinfo/updateLinePortSnmpParam.jsp?eveid=${eveid}&modid=${modid}&ecode=9&major=${major}&description=${description}";
	this.form1.submit();
}
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">线路 / 端口 SNMP性能指标列表</h1>
        <p ></p>
...
<a href="<%=request.getContextPath() %>/secure/baseinfo/updateLinePortSnmpParam.jsp?eveid=${c1.eveid}&modid=${c1.modid}&ecode=6&major=${c1.major}&description=${c1.description}&general=${c1.general}">
<img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16"></a>
&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deleteLinePortSnmpParam.wss?eveid=${c1.eveid}&modid=${c1.modid}&eveidcannotbedeleted=${model.eveides }" onclick="return confirm('确定删除信息?');">
