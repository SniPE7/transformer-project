...
function showoid(opid,oidname,oidindex,oidvalue,oidname,oidunit,flag){
  ...
  alert("***"+document.getElementsByName("formm").item(0).readOnly);
...
function savedetails(){
  ...
  if(confirm("确定保存OID?")){
    formm.action="<%=request.getContextPath() %>/secure/baseinfo/savenewPreDefMiboiddetails.wss";
    formm.submit();
    }
}
  ...
  formm.oidunit.value='';
    ...
    function saveoidgroup(){
      ...
      if(confirm('确定保存该oidgroup?')){
        formm.action="<%=request.getContextPath() %>/secure/baseinfo/saveNewPreDefMiboid.wss";
        formm.submit();
      }
...
function deleteoiddetails(){
   ...
   return ;
      ...
      if(confirm('确定删除所选OID?')){
         formm.action="<%=request.getContextPath() %>/secure/baseinfo/deletePreDefMiboiddetails.wss";
         formm.submit();
       }
    }
...
<body><TABLE WIDTH="98%" CELLPADDING="0" CELLSPACING="0" BORDER="0" class="portalPage"><TR><TD CLASS="pageTitle">基础信息</TD>
          <TD CLASS="pageClose"><a href="<%= request.getContextPath() %>/secure/baseinfo/preDefinedMibIndexOid.wss"><img border="0" src="../../images/back.gif" width="16" height="16"></a></TD>
      </TR>
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">新建私有Mib OID Group</h1>
        <p ></p>
<form action="<%=request.getContextPath() %>/secure/baseinfo/newPreDefMiboid.wss" method="post" name="formm" >
<a name="main"></a>
<!-- button section -->
	...
	<tr class="table-row"><td>
		<table  cellspacing="1" cellpadding="0" border="0" width="100%" VALIGN="top"  class="collection-table-text">
			...
			<tr class="table-row" >
					...
					<td  class="tdcontent"><input type="text" name="oidvalue" value="" class="formStyleblock" maxlength="255">
					* 必填</td>
			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OID 名称
					  <input type="hidden" name="yuanoidname" value="" class="formStyleblock"></td>
					<td  class="tdcontent"><input type="text" name="oidname" value="" class="formStyleblock" maxlength="200">
					* 必填</td>

			</tr>
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OID 单位</td>
					<td  class="tdcontent"><input type="text" name="oidunit" value="" class="formStyleblock" maxlength="32">
					* 必填</td>
			</tr>
			<tr class="table-row"  >
		...
		</table>	<TABLE class="paging-table" BORDER="0" CELLPADDING="5" CELLSPACING="0" WIDTH="100%" SUMMARY="Table for displaying paging function">
