...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TR>
      <TH class="wpsPortletTitle" width="100%">设备类型列表</TH>
...
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0"><tr> 
		...
		<td>
    		<input type="submit" name="button.delete" value="删除" class="buttons" id="functions"/>
    	</td>
...
<tr>
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="mrname">选择
  <input
											type="checkbox" name="chkbox"></th>
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="category">OID 名</th>
</tr>
