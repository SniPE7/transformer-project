...
<html>
<head>
<title>Pre Defined Mib Oid Groups</title>
...
function addform(){
preDefMibOid.formAction.value= 'add';
preDefMibOid.action = "<%=request.getContextPath() %>/secure/baseinfo/newPreDefMiboid.wss";
}
function deleteform(){
	preDefMibOid.formAction.value= 'delete';
	var v = confirm('确定删除信息?');
	if( ! v ){ return false;	}
	if(v){
	preDefMibOid.action = "<%=request.getContextPath() %>/secure/baseinfo/deletePreDefMibOid.wss";
	this.preDefMibOid.submit();
	}
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <a name="important"></a> 
        <h1 id="title-bread-crumb">私有Mib OID Groups</h1>
        <p ></p>
<form action="" method="post" name="preDefMibOid" >
<a name="main"></a>
<!-- button section -->
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0"><tr> 
		<td>
    		<input type="submit" name="button.new" value="新建" onClick="addform();" class="buttons" id="functions" />
    	</td>
...
<a href="<%=request.getContextPath() %>/secure/baseinfo/editPreDefMibOid.wss?opid=${c1.opid }" >
<img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16"></a>&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deletePreDefMibOid.wss?opid=${c1.opid }" onclick="return confirm('确定删除信息?');">
