...
function addform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/baseinfo/newPreDefMibSnmpParam.jsp";
	this.form1.submit();
}
function deleteform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/baseinfo/deletePreDefMibSnmpParam.wss";
	this.form1.submit();
	}
}
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">私有MiB Index SNMP性能指标列表</h1>
        <p ></p>
...
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0"><tr> 
		<td>
    		<input type="submit" name="button.new" value="新建"   onclick="addform1()" class="buttons" id="functions"/>
    	</td>
...
<tr class="table-row" ondbclick="<%=request.getContextPath() %>/secure/baseinfo/updateLinePortSnmpParam.jsp?eveid=${c1.eveid}&modid=${c1.modid}&ecode=9&major=${c1.major}&description=${c1.description}&general=${c1.general}">

<td VALIGN="top"  class="collection-table-text" headers="eveid">
<a href="<%=request.getContextPath() %>/secure/baseinfo/updatePreDefMibSnmpParam.jsp?eveid=${c1.eveid}&modid=${c1.modid}&ecode=9&major=${c1.major}&description=${c1.description}&general=${c1.general}">
<img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16"></a>
&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deletePreDefMibSnmpParam.wss?eveid=${c1.eveid}&modid=${c1.modid}&eveidcannotbedeleted=${model.eveides }" onclick="return confirm('确定删除信息?');">
...
<td VALIGN="top"  class="collection-table-text" headers="mname"><c:out value="${c1.mname}" /> </td>
<td VALIGN="top"  class="collection-table-text" headers="major"><c:out value="${c1.major}"/></td>
