...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">更新线路 /端口 SNMP 性能指标</h1>


<form action="<%=request.getContextPath() %>/secure/baseinfo/updateLinePortSnmpParam.wss" method="post" id="ipnet" name="ipnet">        
...
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
		...
		<div class="sectionHeading" value="详细内容">SNMP 性能指标</div>
		...
		<table class="framing-table" border="0" bordercolor="#999999" cellpadding="3" cellspacing="1" width="100%">
				...
				<tr class="table-row">
				    ...
				    &nbsp;SNMP
					  <input name="modid" value="<%=request.getParameter("modid") %>" id="formStyle1" type="hidden">
