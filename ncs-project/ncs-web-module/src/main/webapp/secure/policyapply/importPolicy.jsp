...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">策略导入</h1>


<form action="<%=request.getContextPath() %>/secure/policyapply/importPolicy.wss" method="post" enctype="multipart/form-data" id="form1" name="form1">        
...
<br/><table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0"><tr> 
		...
		<td>
    		<input type="submit" name="button.import" value="导入" class="buttons" id="functions"/>
    	</td>
