...
<table border="0" cellpadding="3" cellspacing="0" VALIGN="middle" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0" align="center"><tr> 
		<td  class="tdcontent">&nbsp;厂商名：
        	<select name="manufselect" onChange="changemfsel()" id="formStyleblock">
		...
		<td><input type="button" name="button.syslog" value="SYSLOG" onClick="toSyslog();" class="buttons" id="functions"/>&nbsp;
   	</td>
   			<td>
    		<input type="button" name="button.snmp" value="SNMP" onClick="toSNMP();" class="buttons" id="functions"/>&nbsp;
    	</td>
    			<td>
    		<input type="button" name="button.icmp" value="ICMP" onClick="toICMP();" class="buttons" id="functions"/>&nbsp;
   	</td>
 ...
 <c:when test="${model.mode == 'ICMP'}">   
	<div> <!-- start of if mode = ICMP -->
       <table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" SUMMARY="List table" CLASS=" framing-table" id="selTab">
        ...
        <input type="checkbox" name="sel" value="<%=countChecked %>|${c1.modid}|${c1.eveid}|${c1.mpid}" checked="checked"/>
		...
		<td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="v1lseverity1"  		size="5" value="${c1.v1lseverity1}"/><br/><input type="text" 	name="v1lseverityA"  		size="5" value="${c1.v1lseverityA}"/></td>
		<td VALIGN="middle"  class="collection-table-text" >
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="value1"	size="5" value="${c1.value1}"/></td>
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity1"	size="5" value="<c:if test="${c1.severity1Null == false}" >${c1.severity1}</c:if>"/><br />
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity2" 		size="5" value="<c:if test="${c1.severity2Null == false}" >${c1.severity2}</c:if>"/><br/>
		<input type="text" 	name="severityB" 		size="5" value="<c:if test="${c1.severityBNull == false}" >${c1.severityB}</c:if>"/></td>
        <td VALIGN="middle"  class="collection-table-text" >
        ...
        <input type="checkbox" name="oidgroupSel" value="<%=countChecked %>" <c:if test="${c1.oidgroup != null}">checked="checked"</c:if> 
        /></td>
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="oidgroup"	size="5" value="${c1.oidgroup}" />
        </td>
        </tr>
        ...
        <tr class="table-row">
        <td VALIGN="middle"  class="collection-table-text" ><input type="checkbox" name="sel" 	value="<%=countChecked %>|${d1.modid}|${d1.eveid}"    /> 
...
<td VALIGN="middle"  class="collection-table-text" >var0</td>
		<td VALIGN="middle"  class="collection-table-text" >0</td>
		<td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="v1lseverity1"  		size="5" value=""/><br/><input type="text" 	name="v1lseverityA"  		size="5" value=""/></td>
		<td VALIGN="middle"  class="collection-table-text" >
		<select name="value1low" id="value_1_low" >
					<option value="">-请选择-</option>
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity1"	size="5" value=""/><br/>
		<input type="text" 	name="severityA" 		size="5" value=""/></td>
		<td VALIGN="middle"  class="collection-table-text" >
		<select name="value2low" id="value_2_low" >
					<option value="">-请选择-</option>
                    <option value="var1">Ping丢包数目</option>
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity2" 		size="5" value=""/><br/><input type="text" 	name="severityB" 		size="5" value=""/></td>
        <td VALIGN="middle"  class="collection-table-text" >
            <select name="compareType" id="compare_Type" >    
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="oidgroup"	size="5" value="" />
        </td>
        </tr>
...
<c:otherwise>
    ...
    <% countChecked = 0; %>
        ...
        <tr class="table-row">
        <td VALIGN="middle"  class="collection-table-text" align="center" rowspan="2">
        <input type="checkbox" name="sel${u1}" value="<%=countChecked %>|${c1.spid}" checked="checked"/>
        <input type="hidden" name="pre${u1}" value="${c1.spid}|${c1.mpid}" /> 
        </td>
        <td VALIGN="middle"  class="collection-table-text" rowspan="2">
        <input type="hidden" name="mark${u1}" value="<c:out value='${c1.mark}'/>"/>${c1.events}
        <input   type="hidden" name="eventtype${u1}" value="${u1}" /> 
        </td>
        <td VALIGN="middle"  class="collection-table-text" >内</td>
        
        
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity1${u1}" 		size="5" value='<c:if test="${c1.severity1Null == false}" >${c1.severity1}</c:if>'/></td>
        <td VALIGN="middle"  class="collection-table-text" >
            <select name="filterA${u1}" id="filter_A" >
        ...
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity2${u1}" 		size="5" value='<c:if test="${c1.severity2Null == false}" >${c1.severity2}</c:if>'/></td>
        <td VALIGN="middle"  class="collection-table-text" >
            <select name="filterB${u1}" id="filter_B" >
        ...
        <TABLE class="paging-table" BORDER="0" CELLPADDING="5" CELLSPACING="0" WIDTH="100%" SUMMARY="Table for displaying paging function" id="selCountTab">
            ...
            <TR>
                    ...
                    <TD CLASS="table-totals" VALIGN="baseline">               
                    Total Selected ${fn:length(model.details[u1])}
                     &nbsp;&nbsp;&nbsp;               
        ...
        <tr class="table-row">
        <td VALIGN="middle"  class="collection-table-text" rowspan="2"><input type="checkbox" name="sel${u1}" 	value="<%=countChecked %>|<c:out value='${d1.mark}'/>"    /> 
        </td>
        <td VALIGN="middle"  class="collection-table-text" rowspan="2">
        <input type="hidden" name="mark${u1}" value="<c:out value='${d1.mark}'/>"/>  ${d1.events}
        <input type="hidden" name="eventtype${u1}" value="${u1}" /> 
        </td>
        <td VALIGN="middle"  class="collection-table-text" >内</td>
        <td VALIGN="middle"  class="collection-table-text" ><input type="text" 	name="severity1${u1}"	size="5" value=""/>
        </td>
        <td VALIGN="middle"  class="collection-table-text" >
            <select name="filterA${u1}" id="filter_A" >
                    <option value="0">否</option>
        ...
        <TABLE class="paging-table" BORDER="0" CELLPADDING="5" CELLSPACING="0" WIDTH="100%" SUMMARY="Table for displaying paging function" id="unselCountTab">
            ...
            <TR>
                    ...
                    <TD CLASS="table-totals" VALIGN="baseline">               
                    Total Unselected ${fn:length(model.unselected[u1])}
                     &nbsp;&nbsp;&nbsp;               
    	...
    	</td></tr></tbody></table> <!--end of syslog section u1-->
    </c:forEach>
    </div>
</c:otherwise>
</c:choose>
