                    ...
                    <td colspan="3" class="wpsPortletTitle">
                        ...
                        <table border="0" width="100%" cellpadding="0" cellspacing="0" >
                            <tr>
									...
									<td width="100%" nowrap valign="middle" class="wpsPortletTitleText">&nbsp;欢迎使用策略模板定义</td>
...
<table width="100%" cellpadding="8" cellspacing="0" border="0">
	<tr>
		...
		<div class="instruction-text">NetCool信息管理系统<span style="color:#F00">策略模板定义</span>模块可用于配置管理以下内容。<br>
		</div>
		<br>
		<br>
