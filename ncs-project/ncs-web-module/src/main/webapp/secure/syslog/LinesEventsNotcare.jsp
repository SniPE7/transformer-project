...
function add(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/syslog/linesnotcare.jsp";
	this.form1.submit();
}
function deleteform1(){
	...
	form1.action = "<%=request.getContextPath() %>/secure/syslog/deletelinesnotcare.wss";
	this.form1.submit();
}
...
<body>
  ...
  <TABLE WIDTH="98%" CELLPADDING="0" CELLSPACING="0" BORDER="0" class="portalPage">
      <TR>
          <TD CLASS="pageTitle">Lines Events Not Care列表</TD>
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TR>
      <TH class="wpsPortletTitle" width="100%">Lines Events Not Care列表</TH>
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">Lines Events Not Care</h1>
        <p ></p>
...
<th NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" >LINESNOTCARE</th>
...
<tr class="table-row">
<td VALIGN="top"  class="collection-table-text" headers="mark"><input	type="checkbox" name="del" value="${c1.linesNotCare}"></td>
<td VALIGN="top"  class="collection-table-text" style="word-break:break-all"><c:out value="${c1.linesNotCare }"/></td>
