...
/*  public SSOPrincipalImpl(Subject userSubject){
    this.cn = "";
  }
  
  private static Principal valueOf(Subject userSubject){
    ...
    Set<Object> publicCredentials = userSubject.getPublicCredentials();

    Set<Object> privateCredentials = userSubject.getPrivateCredentials();
  }*/
