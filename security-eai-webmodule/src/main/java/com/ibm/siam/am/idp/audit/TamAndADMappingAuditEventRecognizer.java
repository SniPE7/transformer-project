...
import com.ibm.siam.am.idp.authn.module.TamMappingLoginModule;
 ...
 *
 */
public class TamAndADMappingAuditEventRecognizer extends AbstractAuditEventRecognizer {

  /**
   * 
   */
  public TamAndADMappingAuditEventRecognizer() {
    super();
  }
