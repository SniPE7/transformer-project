...
public class ChainAuditEventRecognizer implements AuditEventRecognizer {
  ...
  /* (non-Javadoc)
   * @see com.sinopec.siam.am.idp.audit.AuditEventRecognizer#recognizeAndRecord(com.sinopec.siam.am.idp.authn.LoginModuleEvent)
   */
  ...
  /* (non-Javadoc)
   * @see com.sinopec.siam.am.idp.audit.AuditEventRecognizer#recognizeAndRecord(com.sinopec.siam.am.idp.authn.LoginContextEvent)
   */
