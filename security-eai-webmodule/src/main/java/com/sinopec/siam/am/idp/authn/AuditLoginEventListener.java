...
import com.sinopec.siam.am.idp.audit.AuditEventRecognizer;
...
public class AuditLoginEventListener implements LoginContextEventListener, LoginModuleEventListener {
  ...
  /* (non-Javadoc)
   * @see com.sinopec.siam.am.idp.authn.LoginModuleEventListener#fireEvent(com.sinopec.siam.am.idp.authn.LoginModuleEvent)
   */
  ...
  /* (non-Javadoc)
   * @see com.sinopec.siam.am.idp.authn.LoginContextEventListener#fireEvent(com.sinopec.siam.am.idp.authn.LoginContextEvent)
   */
