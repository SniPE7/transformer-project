...
public class TLSClientLoginHandler extends AbstractLoginHandler {

  /** Class logger. */
  private final Logger log = LoggerFactory.getLogger(TLSClientLoginHandler.class);
   ...
   *          with "/"
   */
  public TLSClientLoginHandler(String servletPath) {
    super();
