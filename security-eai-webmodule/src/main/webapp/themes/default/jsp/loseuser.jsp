        ...
        <div>
          <div id="wizard" class="swMain">
					...
					<div id="step-1">
			               	...
			               	<div id="idcard"> 
			               		<label for="j_idcard">身份证号/ID Number</label>
					...
					<div id="step-2">
							 <div id="nomobile" style="display: none;"> 
								<label>你目前没有注册的手机信息，请联系人力资源部修改.</label>
			               		<label>Could not found your mobile number, please contact with HR. </label>
			               	</div>
			               	
			               	<div id="hadmobile" style="display: none;"> 
			               	
			               		<label>用户名将通过短信发送到您的手机.</label>
			               		<label>Your username will be sent to the registered mobile phone. </label>
			               		<label id="lb_usr_mobile" class="float-left"></label>
			               		
			               		<label>如果手机号码不正确，请联系人力资源部修改.</label>
			               		<label>If this mobile number is wrong, please contact with HR. </label>
			               	</div>
					...
					<div id="step-3">
			               	...
			               	<div id="sendusername"> 
			               		...
			               		<label>您的用户名已经发出到如下手机：</label>
			               		<label>Your username has been sent to the mobile: </label>
			               		<label id="lb_usr_mobile" class="float-left"></label>
			               	</div>
