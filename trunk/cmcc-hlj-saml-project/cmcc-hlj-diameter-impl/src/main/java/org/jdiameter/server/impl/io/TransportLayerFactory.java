...
import org.jdiameter.server.impl.io.tcp.TLSNetWorkGuard;

public class TransportLayerFactory extends
		org.jdiameter.client.impl.transport.TransportLayerFactory implements
	...
	public INetworkGuard createNetworkGuard(InetAddress inetAddress, int port)
			throws TransportException {
		INetworkGuard guard;
		try {
			guard = new TLSNetWorkGuard(config, inetAddress, port,
	...
	public INetworkGuard createNetworkGuard(InetAddress inetAddress,
			final int port, final INetworkConnectionListener listener)
			throws TransportException {
		INetworkGuard guard;
		try {
			guard = new TLSNetWorkGuard(config, inetAddress, port,
