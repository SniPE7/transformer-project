...
public class LDAPSessionManagerImpl implements SessionManager {
   ...
   * .ContactDTO)
   */
  public boolean touch(String uniqueIdentifier) throws SessionManagementException {
    ...
    try {
      ctx = new InitialDirContext(env);
      String filter = "(" + attributeName + "=" + uniqueIdentifier + ")";
      List<String> entities = ldapTemplate.search(base, filter, new ContextMapper() {
   ...
   * .ContactDTO)
   */
  public boolean destroy(String uniqueIdentifier) throws SessionManagementException {
    Hashtable<String, String> env = new Hashtable<String, String>();
    ...
    try {
      ctx = new InitialDirContext(env);
      String filter = "(" + "uniqueIdentifier" + "=" + uniqueIdentifier + ")";
      List<String> entities = ldapTemplate.search(base, filter, new ContextMapper() {
