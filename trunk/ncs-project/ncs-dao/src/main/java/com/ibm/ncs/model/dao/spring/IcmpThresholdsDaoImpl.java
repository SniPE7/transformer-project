...
public class IcmpThresholdsDaoImpl extends AbstractDAO implements ParameterizedRowMapper<IcmpThresholds>, IcmpThresholdsDao
{
	...
	{
		jdbcTemplate.update("INSERT INTO " + getTableName() + " ( IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )",dto.getIpaddress(),dto.getBtime(),dto.getEtime(),dto.getThreshold(),dto.getComparetype(),dto.getSeverity1(),dto.getSeverity2(),dto.isFilterflag1Null()?null:dto.getFilterflag1(),dto.isFilterflag2Null()?null:dto.getFilterflag2(),dto.getVarlist(),dto.getSummarycn());
		return dto.createPk();
	}
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET IPADDRESS = ?, BTIME = ?, ETIME = ?, THRESHOLD = ?, COMPARETYPE = ?, SEVERITY1 = ?, SEVERITY2 = ?, FILTERFLAG1 = ?, FILTERFLAG2 = ?, VARLIST = ?, SUMMARYCN = ? WHERE IPADDRESS = ?",dto.getIpaddress(),dto.getBtime(),dto.getEtime(),dto.getThreshold(),dto.getComparetype(),dto.getSeverity1(),dto.getSeverity2(),dto.getFilterflag1(),dto.getFilterflag2(),dto.getVarlist(),dto.getSummarycn(),pk.getIpaddress());
	}
	...
	{
		try {
			List<IcmpThresholds> list = jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE IPADDRESS = ?", this,ipaddress);
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " ORDER BY IPADDRESS", this);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE IPADDRESS = ? ORDER BY IPADDRESS", this,ipaddress);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE BTIME = ? ORDER BY BTIME", this,btime);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE ETIME = ? ORDER BY ETIME", this,etime);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE THRESHOLD = ? ORDER BY THRESHOLD", this,threshold);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE COMPARETYPE = ? ORDER BY COMPARETYPE", this,comparetype);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE SEVERITY1 = ? ORDER BY SEVERITY1", this,severity1);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE SEVERITY2 = ? ORDER BY SEVERITY2", this,severity2);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE FILTERFLAG1 = ? ORDER BY FILTERFLAG1", this,filterflag1);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE FILTERFLAG2 = ? ORDER BY FILTERFLAG2", this,filterflag2);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE VARLIST = ? ORDER BY VARLIST", this,varlist);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT IPADDRESS, BTIME, ETIME, THRESHOLD, COMPARETYPE, SEVERITY1, SEVERITY2, FILTERFLAG1, FILTERFLAG2, VARLIST, SUMMARYCN FROM " + getTableName() + " WHERE SUMMARYCN = ? ORDER BY SUMMARYCN", this,summarycn);
		}
		catch (Exception e) {
			throw new IcmpThresholdsDaoException("Query failed", e);
		}
	...
	public void update(IcmpThresholds dto) {
		jdbcTemplate.update("Update " + getTableName() + " set   BTIME=?, ETIME=?, THRESHOLD=?, COMPARETYPE=?, SEVERITY1=?, SEVERITY2=?,  FILTERFLAG1=?,FILTERFLAG2=?,VARLIST=?,SUMMARYCN=?  " +
				" where ipaddress=? "
				,dto.getBtime(),dto.getEtime(),dto.getThreshold(),dto.getComparetype(),dto.getSeverity1(),dto.getSeverity2(),dto.getFilterflag1(),dto.getFilterflag2(),dto.getVarlist(),dto.getSummarycn(),dto.getIpaddress());
	...
	public int insertEffect()
	{
		...
		String sqldev  = "select devip ipaddress, btime, etime, " +
				...
				" "+s1+"||(case when value_1_low is not null and trim(length(value_1_low))<>0  and value_1_low='var1' then '|'||"+s2+" when value_1_low is not null and trim(length(value_1_low))<>0  and value_1_low='var2' then '|'||"+s3+" end)" +
					   "||(case when value_2_low is not null and trim(length(value_2_low))<>0  and value_2_low='var1' then '|'||"+s2+" when value_2_low is not null and trim(length(value_2_low))<>0  and value_2_low='var2' then '|'||"+s3+" end) summaryCN " +
		...
		String sqlport = "select ifip ipaddress, btime, etime, " +
				...
				" "+s1+"||(case when value_1_low is not null and trim(length(value_1_low))<>0  and value_1_low='var1' then '|'||"+s2+" when value_1_low is not null and trim(length(value_1_low))<>0  and value_1_low='var2' then '|'||"+s3+" end)" +
					   "||(case when value_2_low is not null and trim(length(value_2_low))<>0  and value_2_low='var1' then '|'||"+s2+" when value_2_low is not null and trim(length(value_2_low))<>0  and value_2_low='var2' then '|'||"+s3+" end) summaryCN " +
				" from v_icmp_port_thresholds where (ifip is not null or trim(ifip) <>'')" +
				" and ifip not in ( select devip from v_icmp_dev_thresholds )";
/*		
		String sqlpdm  = "select oidname ipaddress, btime, etime, " +
				...
				" "+s1+"||(case when value_1_low is not null and value_1_low='var1' then '|'||"+s2+" when value_1_low is not null and value_1_low='var2' then '|'||"+s3+" end)" +
					   "||(case when value_2_low is not null and value_2_low='var1' then '|'||"+s2+" when value_2_low is not null and value_2_low='var2' then '|'||"+s2+" end) summaryCN " +
...
/*
		try {
			ret += jdbcTemplate.update("INSERT INTO " + getTableName() +"("+sqlpdm+")" ,this);
		} catch (DataAccessException e) {
			e.printStackTrace();
		}
	*/
