...
/** 
 * This class represents the primary key of the BK_SYSLOG_EVENTS_PROCESS_NS table.
 */
public class BkSyslogEventsProcessNsPk implements Serializable
{
	protected long bkId;
	...
	/**
	 * Method 'BkSyslogEventsProcessNsPk'
	 * 
	 */
	public BkSyslogEventsProcessNsPk()
	{
	}
	 ...
	 * @param bkId
	 */
	public BkSyslogEventsProcessNsPk(final long bkId)
	{
		this.bkId = bkId;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BkSyslogEventsProcessNsPk)) {
			return false;
		}
		
		final BkSyslogEventsProcessNsPk _cast = (BkSyslogEventsProcessNsPk) _other;
		if (bkId != _cast.bkId) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.BkSyslogEventsProcessNsPk: " );
