...
public class SyslogEventsProcessNs implements Serializable
{
	/** 
	 * This attribute maps to the column MARK in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String mark;

	/** 
	 * This attribute maps to the column VARLIST in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String varlist;

	/** 
	 * This attribute maps to the column BTIMELIST in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String btimelist;

	/** 
	 * This attribute maps to the column ETIMELIST in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String etimelist;

	/** 
	 * This attribute maps to the column FILTERFLAG1 in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column FILTERFLAG2 in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY1 in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column SEVERITY2 in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column PORT in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String port;

	/** 
	 * This attribute maps to the column NOTCAREFLAG in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column TYPE in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected long type;
	...
	/** 
	 * This attribute maps to the column EVENTTYPE in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column SUBEVENTTYPE in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column ALERTGROUP in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String alertgroup;

	/** 
	 * This attribute maps to the column ALERTKEY in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String alertkey;

	/** 
	 * This attribute maps to the column SUMMARYCN in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String summarycn;

	/** 
	 * This attribute maps to the column PROCESSSUGGEST in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String processsuggest;

	/** 
	 * This attribute maps to the column STATUS in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String status;

	/** 
	 * This attribute maps to the column ATTENTIONFLAG in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	...
	/** 
	 * This attribute maps to the column EVENTS in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String events;

	/** 
	 * This attribute maps to the column MANUFACTURE in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String manufacture;

	/** 
	 * This attribute maps to the column ORIGEVENT in the SYSLOG_EVENTS_PROCESS_NS table.
	 */
	protected String origevent;

	/**
	 * Method 'SyslogEventsProcessNs'
	 * 
	 */
	public SyslogEventsProcessNs()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SyslogEventsProcessNs)) {
			return false;
		}
		
		final SyslogEventsProcessNs _cast = (SyslogEventsProcessNs) _other;
	 ...
	 */
	public SyslogEventsProcessNsPk createPk()
	{
		return new SyslogEventsProcessNsPk(mark, manufacture);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.SyslogEventsProcessNs: " );
