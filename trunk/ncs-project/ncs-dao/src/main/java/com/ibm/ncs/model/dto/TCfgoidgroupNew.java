...
public class TCfgoidgroupNew implements Serializable
{
	/** 
	 * This attribute maps to the column S_NO in the T_CFGOIDGROUP_NEW table.
	 */
	protected Long sNo;

	/** 
	 * This attribute maps to the column OIDGROUPNAME in the T_CFGOIDGROUP_NEW table.
	 */
	protected String oidgroupname;

	/** 
	 * This attribute maps to the column OIDVALUE in the T_CFGOIDGROUP_NEW table.
	 */
	protected String oidvalue;

	/** 
	 * This attribute maps to the column OIDNAME in the T_CFGOIDGROUP_NEW table.
	 */
	protected String oidname;

	/** 
	 * This attribute maps to the column OIDINDEX in the T_CFGOIDGROUP_NEW table.
	 */
	protected Long oidindex;

	/** 
	 * This attribute maps to the column OIDUNIT in the T_CFGOIDGROUP_NEW table.
	 */
	protected String oidunit;

	/** 
	 * This attribute maps to the column NMSIP in the T_CFGOIDGROUP_NEW table.
	 */
	protected String nmsip;

	/** 
	 * This attribute maps to the column TARFILENAME in the T_CFGOIDGROUP_NEW table.
	 */
	protected String tarfilename;

	/**
	 * Method 'TCfgoidgroupNew'
	 * 
	 */
	public TCfgoidgroupNew()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TCfgoidgroupNew)) {
			return false;
		}
		
		final TCfgoidgroupNew _cast = (TCfgoidgroupNew) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.TCfgoidgroupNew: " );
		ret.append( "sNo=" + sNo );
