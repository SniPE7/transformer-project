...
/** 
 * This class represents the primary key of the T_POLICY_DEFAULT table.
 */
public class TPolicyDefaultPk implements Serializable
{
	...
	/**
	 * Method 'TPolicyDefaultPk'
	 * 
	 */
	public TPolicyDefaultPk()
	{
	}
	 ...
	 * @param eveid
	 */
	public TPolicyDefaultPk(final long modid, final long eveid)
	{
		this.modid = modid;
		this.eveid = eveid;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TPolicyDefaultPk)) {
			return false;
		}
		
		final TPolicyDefaultPk _cast = (TPolicyDefaultPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.TPolicyDefaultPk: " );
