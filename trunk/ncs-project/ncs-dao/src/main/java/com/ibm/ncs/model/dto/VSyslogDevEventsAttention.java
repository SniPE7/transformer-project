...
public class VSyslogDevEventsAttention implements Serializable
{
	/** 
	 * This attribute maps to the column DEVIP in the V_SYSLOG_DEV_EVENTS_ATTENTION table.
	 */
	protected String devip;

	/** 
	 * This attribute maps to the column MARK in the V_SYSLOG_DEV_EVENTS_ATTENTION table.
	 */
	protected String mark;

	/** 
	 * This attribute maps to the column SEVERITY1 in the V_SYSLOG_DEV_EVENTS_ATTENTION table.
	 */
	...
	/** 
	 * This attribute maps to the column PROCESSSUGGEST in the V_SYSLOG_DEV_EVENTS_ATTENTION table.
	 */
	protected String processsuggest;

	/**
	 * Method 'VSyslogDevEventsAttention'
	 * 
	 */
	public VSyslogDevEventsAttention()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof VSyslogDevEventsAttention)) {
			return false;
		}
		
		final VSyslogDevEventsAttention _cast = (VSyslogDevEventsAttention) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.VSyslogDevEventsAttention: " );
