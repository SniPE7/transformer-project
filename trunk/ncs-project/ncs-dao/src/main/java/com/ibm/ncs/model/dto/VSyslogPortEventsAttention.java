...
public class VSyslogPortEventsAttention implements Serializable
{
	/** 
	 * This attribute maps to the column DEVIP in the V_SYSLOG_PORT_EVENTS_ATTENTION table.
	 */
	protected String devip;

	/** 
	 * This attribute maps to the column MARK in the V_SYSLOG_PORT_EVENTS_ATTENTION table.
	 */
	protected String mark;

	/** 
	 * This attribute maps to the column SEVERITY1 in the V_SYSLOG_PORT_EVENTS_ATTENTION table.
	 */
	...
	/** 
	 * This attribute maps to the column PROCESSSUGGEST in the V_SYSLOG_PORT_EVENTS_ATTENTION table.
	 */
	protected String processsuggest;

	/**
	 * Method 'VSyslogPortEventsAttention'
	 * 
	 */
	public VSyslogPortEventsAttention()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof VSyslogPortEventsAttention)) {
			return false;
		}
		
		final VSyslogPortEventsAttention _cast = (VSyslogPortEventsAttention) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.ibm.ncs.model.dto.VSyslogPortEventsAttention: " );
