...
public class DeleteIcmpParamGroupsController extends SimpleFormController implements Controller {
...
//		System.out.println("eveidstr is---"+eveidstr);
	...
	//	}
		...
		if(returntojsp == true){
			message = "<script language='javascript'>alert('该性能指标定制了策略，不能删除！');</script>";
