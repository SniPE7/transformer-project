...
public class SaveLineportOidGroupDetailsController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try {
			...
			System.out.println("opid is-------"+opidStr);
			...
			if(opidStr == null) opidStr="";
			long opid = Long.parseLong(opidStr);
			//long oidindex = Long.parseLong(oidindexStr);
//			System.out.println("from jsp opid is"+opid+"unit is"+oidunit+"index is"+oidindexStr+"checkbps is"+checkbps+"flag is"+flag);
			...
			//		model.put("dto1", dto1);
				...
				Log4jInit.ncsLog.info(this.getClass().getName() + " Inserted to TOidgroupDetailsInitDao: " + dto1.toString());	
					...
					message = "baseinfo.newsnmp.dul";
					Log4jInit.ncsLog.info(this.getClass().getName() + " Inserted to tOidgroupInfoInitDao Failed: " + dto1.toString()+de);
				}catch(Exception e){
					...
					Log4jInit.ncsLog.info(this.getClass().getName() + " Inserted to tOidgroupInfoInitDao Failed: " + dto1.toString()+e);	
					List<TManufacturerInfoInit> mflist = TManufacturerInfoInitDao.findAll();
					SortList<TManufacturerInfoInit> sortmanu = new SortList<TManufacturerInfoInit>();
					sortmanu.Sort(mflist, "getMrname", null);
