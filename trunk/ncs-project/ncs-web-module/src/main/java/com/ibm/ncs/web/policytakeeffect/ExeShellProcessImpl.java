...
public class ExeShellProcessImpl implements ExeShellProcess {

	Logger logger = Logger.getLogger(ExeShellProcessImpl.class);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.ncs.web.policytakeeffect.ExeShellProcess#init()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.ncs.web.policytakeeffect.ExeShellProcess#startProcess()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.ncs.web.policytakeeffect.ExeShellProcess#stopProcess()
	 */
	...
	public void operations() {
		...
		try {
			...
			// long delay = checkFireTime(waituntil); // no more delay for stop
			// service
			//
			// delay = 0;
	...
	public static void main(String[] args) {
		ExeShellProcessImpl exsh = new ExeShellProcessImpl();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.ncs.web.policytakeeffect.ExeShellProcess#getStat()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ibm.ncs.web.policytakeeffect.ExeShellProcess#isDone()
	 */
	 ...
	 * 
	 * @see
	 * com.ibm.ncs.web.policytakeeffect.ExeShellProcess#setOperator(java.lang.
	 * String)
	 */
