...
public class NewSyslogController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		try {
			...
			SyslogEventsProcess syslogs = syslogEventsProcessDao.findByPrimaryKey(mark, manufacture);
			if(syslogs != null){
			...
			System.out.println("varlist--"+varlist+"--btimelist--"+btimelist+"--etimelist--"+etimelist+"--filterflag1--"+filterflag1
				...
				System.out.println("tabList size is "+tabList.size());
