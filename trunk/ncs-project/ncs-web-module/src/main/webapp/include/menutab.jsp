...
function loadGenerateConfig(){
	...
	window.open("<%=request.getContextPath()%>/secure/output/genpolicyfile.jsp",
						"detail");
		window.close();
	}
...
<body class="tundra">
	<div dojotype="dijit.layout.TabContainer" id="nmsmenu" style="height: 100%; background-color: transparent; width: 100%">
		<div dojotype="dijit.layout.ContentPane" id="baseinfomenu" title="基础信息" style='background-color: transparent;'>
			<div id="baseinfotab">
				<span class="wpsToolbarBannerBackground" onClick="loadBasicInfo();"> <a href="#">基础信息维护</a> <!--<a href="" target="navigator">基础信息维护</a>-->
				</span> &nbsp;|&nbsp;
		...
		<div dojotype="dijit.layout.ContentPane" id="resmenu" title="资源管理" style='background-color: transparent;'>
			<div id="resourcetab">
				<span class="wpsToolbarBannerBackground" onClick="loadIPAddr();"> <a href="#"> IP地址规划</a> <!--<a href="<%=request.getContextPath()%>/secure/resourceman/naviipnet.wss" target="navigator">IP地址规划</a>-->
				</span> &nbsp;|&nbsp; <span class="wpsToolbarBannerBackground" onClick="loadNetworkDevice();"> <a href="#">网络设备 </a> <!--<a href="" target="navigator">网络设备</a>-->
				</span> &nbsp;|&nbsp; <span class="wpsToolbarBannerBackground" onClick="loadNetworkMgrmt();"> <a href="#">网管系统规划</a> <!--<a href="" target="navigator">网络系统规划</a>-->
				</span> &nbsp;|&nbsp;
			</div>
    ...
    boolean isAdmin = false;
		if (request.getSession(false) != null) {
	  	java.util.List<com.ibm.ncs.model.dto.TRoleAndServerNode> roles = (java.util.List<com.ibm.ncs.model.dto.TRoleAndServerNode>)request.getSession(false).getAttribute("roles");
			if (roles != null) {
		...
		<div dojotype="dijit.layout.ContentPane" id="policytemplateapplymenu" title="策略模板" style='background-color: transparent;'>
			<div id="policyapptab">
				...
				<span class="wpsToolbarBannerBackground" onClick="loadPollicyTemplateDef();"> <a href="#">策略模板定义</a> <!--<a href="" target="navigator">监控策略定义</a>-->
				</span>
			</div>
		</div>
		<%
		...
		<div dojotype="dijit.layout.ContentPane" id="policyapplymenu" title="策略应用" style='background-color: transparent;'>
			<div id="policyapptab">
				...
				</span> &nbsp;|&nbsp; <span class="wpsToolbarBannerBackground" onClick="loadPolicyApply();"> <a href="#">策略应用</a> <!--<a href="" target="navigator">策略应用</a>-->
				</span> &nbsp;|&nbsp; <span class="wpsToolbarBannerBackground" onClick="loadGenerateConfig();"> <a href="#"> 生成监控配置 </a> <!--<a href="" target="navigator">生成监控配置</a>-->
				</span>
			</div>
		</div>
		<div dojotype="dijit.layout.ContentPane" id="maintainmenu" title="数据库维护" style='background-color: transparent;'>
			<div id="maintaintab">
				...
				<span class="wpsToolbarBannerBackground" onclick="loadMaintainDb();"> <a href="#"> 数据库维护</a> <!--                <a href="<%=request.getContextPath()%>/secure/maintain/naviDbMaintain.jsp" target="navigator">数据库维护</a>-->
				</span>
			</div>
		</div>
	</div>
