...
<script type="text/javascript">
  ...
  function onNew(){
    form1.action = "<%=request.getContextPath() %>/secure/baseinfo/newDeviceType.jsp";
    this.form1.submit();
...
<table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" CLASS="button-section">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="0" cellpadding="0" border="0"><tr> 
		<td>
    		<input type="button" name="button.new" value="新建" onClick="onNew();" class="buttons" id="functions"/>
    	</td>
...
<thead>
<tr>
<th NOWRAP VALIGN="BOTTOM" class="table-sortable:numeric column-head-name" SCOPE="col" id="mrname" width="80">编辑/ 删除</th>
<th NOWRAP VALIGN="BOTTOM" class="table-sortable:default column-head-name" SCOPE="col" id="category">设备类型名称&nbsp;<input name="filter" size="15" onkeyup="Table.filter(this,this)"></th>

</tr>
</thead>
<c:forEach items="${model.category}" var="c1" >
<tr class="table-row">
<td VALIGN="top"  class="collection-table-text" headers="id">
<a href="<%=request.getContextPath() %>/secure/baseinfo/updateToDeviceCategory.wss?id=${c1.id}""  >
			<img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16" alt="编辑"></a>

&nbsp;&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deleteDeviceCategory.wss?id=${c1.id }" onclick="return confirm('确定删除信息?');">
			<img border="0" src="../../images/delete.gif" width="16" height="16" alt="删除"></a>
</td>
<td VALIGN="top"  class="collection-table-text" headers="name"><c:out value="${c1.name}" /> </td>
...
<TABLE class="paging-table" BORDER="0" CELLPADDING="5" CELLSPACING="0" WIDTH="100%" SUMMARY="Table for displaying paging function">
	...
	<TR>
            ...
            Total ${fn:length(model.category)}
             &nbsp;&nbsp;&nbsp;               
