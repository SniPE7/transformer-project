...
function saveoidgroup(){
      ...
      if(saveflag == "yes"){
        ...
        formm.action="<%=request.getContextPath() %>/secure/baseinfo/savePreDefMibOid.wss" ;
        formm.submit();
      }
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">更新私有MIB OID Group</h1>
        <p ></p>
		...
		<table  cellspacing="1" cellpadding="3" border="0" width="100%" class="framing-table">
			...
			<tr class="table-row" >
					<td width="20%"  class="tdlabel">OIDGroup 名称
					  <input type="hidden" name="opid" value="${model.opid}"></td>
					<td  >&nbsp;
	...
	<tr class="table-row"><td>
		...
		<table  cellspacing="1" cellpadding="0"
			...
			<c:forEach items="${model.details}" var="theO" >
				<tr class="table-row" >
					<td nowrap="nowrap"><!--<input type="checkbox" id="oiddids" name="oiddetailsid" value="${theO.opid }" />-->
                    ...
                    &nbsp;
                    <a href="<%=request.getContextPath()%>/secure/baseinfo/ deletePreDefMiboiddetails.wss?opid=${theO.opid }&oidname=${theO.oidname }&oidunit=${theO.oidunit }&oidindex=${theO.oidindex }" onclick="return confirm('确定删除信息?');"><img border="0" src="../../images/delete.gif" width="16" height="16" alt="删除"></a>
                    </td>
