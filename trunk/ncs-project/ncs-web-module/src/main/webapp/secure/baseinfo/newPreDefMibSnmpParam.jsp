...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">新建私有 MIB Index SNMP 性能指标</h1>


<form action="<%=request.getContextPath() %>/secure/baseinfo/newPreDefinedMibIndexSnmpParam.wss" method="post" id="predefmib" name="predefmib"   >     
		...
		<table class="framing-table" border="0" bordercolor="#999999" cellpadding="3" cellspacing="1" width="100%">
				...
				<tr class="table-row">
					...
					<td class="tdcontent">
							...
							&nbsp;<input name="major" id="formStyle1" value="${model.major}" maxlength="64" style="width: 400px">
