...
<a name="main"></a>
<input type="hidden" value="${model.searchresult }" name="searchresult">
<!-- button section -->
...
<td>
<a href="<%=request.getContextPath() %>/secure/baseinfo/updateToDevicetypelist.wss?dtid=${c1.dtid}&mf=${c1.mrName }&cate=${c1.cateName }&subcate=${c1.subCategory }"><img border="0" src="../../images/wtable_edit_sorts.gif" width="16" height="16" alt="编辑"></a>
&nbsp;
<a href="<%=request.getContextPath() %>/secure/baseinfo/deleteDevicetypelist.wss?dtid=${c1.dtid }&mf=${c1.mrName }&cate=${c1.cateName }&subcate=${c1.subCategory }" onclick="return confirm('确定删除信息?');">
