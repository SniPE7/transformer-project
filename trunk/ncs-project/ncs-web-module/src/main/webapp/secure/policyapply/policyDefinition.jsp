...
<body  <c:if test="${definition.refresh eq 'true'}">onLoad="reloadNavi()"</c:if> class="navtree" style="background-color:#FFFFFF;"  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  >
        ...
        <table border="0" cellpadding="3" cellspacing="0" valign="top" width="100%" summary="Framing Table" class="button-section">
          ...
          <tr valign="top">
			...
			<td><input type="submit" name="button_bind" value="策略定制" class="buttons" onClick="policydetails()" id="functions"  /></td>
              ...
              <input type="hidden" name="formAction" value="test"/></td>
          </tr>
        </table>
  ...
  <tr valign="top">
    ...
    <table style="display: inline; font-size: 95%;" cellspacing="3" cellpadding="5" border="0"><tr> 
		...
		<c:if test="${definition.message != null &&  definition.message != ''}">
			<div id="errmsg"><fmt:message>${definition.message }</fmt:message></div>
		</c:if>
		</tr>
		<tr></tr>
    ...
    <td>备注</td>
		<td >
    		<textarea rows="4" cols="20" name="description"  style="width: 245px">${definition.policybase.description}</textarea>
    	</td>
    	</tr>
    </table>  
