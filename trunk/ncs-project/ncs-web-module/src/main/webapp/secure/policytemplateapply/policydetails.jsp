...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0//EN"><%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
																...
																<table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" SUMMARY="List table" CLASS=" framing-table" id="selTab">
																	...
																	<c:forEach items="${model.details}" var="c1" varStatus="idx">
																		<tr class="table-row" style="background-color: <c:if test="${idx.index % 2 == 1 }">#ffffff</c:if><c:if test="${idx.index % 2 == 0 }">#e7e7e7</c:if>;">
																			...
																			<td VALIGN="middle" class="collection-table-text" nowrap="nowrap"><input type="text" name="poll" size="5" value="<c:if test="${c1.pollNull == false}" >${c1.poll}</c:if>"
																				...
																				<table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" SUMMARY="List table" CLASS=" framing-table">
																					...
																					<c:forEach items="${model.unselected}" var="d1" varStatus="idx">
																						...
																						<tr class="table-row" style="background-color: <c:if test="${idx.index % 2 == 1 }">#ffffff</c:if><c:if test="${idx.index % 2 == 0 }">#e7e7e7</c:if>;">
																							...
																							<td VALIGN="middle" class="collection-table-text" nowrap="nowrap"><input type="text" name="poll" size="5" value="300" style="width: 40px;" />秒</td>
