...
function updatedo(response){
	if(response=='1') alert('SNMP 测试成功 !!');
	if(response=='0') alert('SNMP 测试失败 !');
}
...
<body onLoad="initAll();" class="navtree" style="background-color:#FFFFFF;"  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  >
 ...
 <TABLE WIDTH="98%" CELLPADDING="0" CELLSPACING="0" BORDER="0" class="portalPage">
      <TR>
          <TD CLASS="pageTitle"><span class="wpsPortletArea">增加设备详细内容</span></TD>
...
<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0">
  ...
  <TR>
      <TH class="wpsPortletTitle" width="100%"><span class="wpsPortletArea">增加设备详细内容</span></TH>
  ...
  <TD CLASS="wpsPortletArea" COLSPAN="3" >
        ...
        <h1 id="title-bread-crumb">增加设备详细内容
...
<!--								</tr>-->
								...
								<tr>
									<td>SNMP版本</td>
									<td><select name="snmpversion">
										<option value="Please choose one">请选择</option>
