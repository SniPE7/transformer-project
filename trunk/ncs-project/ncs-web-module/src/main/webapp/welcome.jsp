													...
													<td colspan="3" class="wpsPortletTitle">
														...
														<table border="0" width="100%" cellpadding="0" cellspacing="0">
															<tr>
																...
																<td width="100%" nowrap valign="middle" class="wpsPortletTitleText">欢迎界面</td>
																<td>?</td>
																		...
																		<tr>
																			<td class="iscPortletArea" colspan="2">
																				<div class="instruction-text">
																					NetCool信息管理系统是管理各种参数的通用管理平台。 此系统可用于配置管理以下内容。<br>
																				</div> <br> <br>
																				<table border="0" cellpadding="3" cellspacing="0" width="100%" class="wpsTable">

																					<tr class="portlet-table-selected">


																						<td valign="top" class="wpsTableHead" nowrap>系统名</td>
																						<td valign="top" class="wpsTableHead" nowrap>版本</td>
																					...
																					<tr class="wpsTableRow">
																						...
																						<td class="portlet-table-body">1.5.4</td>
													...
													<td colspan="3" class="wpsPortletTitle">
														<table border="0" width="100%" cellpadding="0" cellspacing="0">
															<tr>
																...
																<td width="100%" nowrap valign="middle" class="wpsPortletTitleText">关于NetCool信息管理系统</td>
...
TEXTAREA {
	...
	<form>
		...
		<div align="center">
			<textarea dir="ltr" name="abouttext" rows='8' cols='40' class="desctext" readonly>
...
&nbsp;
																	...
																	</html> <!-- deal with dynamic title here -->
