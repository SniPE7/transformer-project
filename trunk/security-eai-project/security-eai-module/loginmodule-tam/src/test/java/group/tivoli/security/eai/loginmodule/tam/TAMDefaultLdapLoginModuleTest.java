 ...
 * 类（接口）继承、实现、功能等描述
 * @author xuhong
 * @since 2012-11-30 下午2:47:54
 */

public class TAMDefaultLdapLoginModuleTest extends TestCase {
   ...
   */
  public void testLoginCaseReturnAllAttributesByUid() throws Exception {
    TAMDefaultLdapLoginModule lm = new TAMDefaultLdapLoginModule();
      ...
      public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        for (Callback cb: callbacks) {
           if (cb instanceof NameCallback) {
              ((NameCallback)cb).setName("JPMGR001");
   ...
   * Test method for {@link edu.vt.middleware.ldap.jaas.LdapLoginModule#login()}.
   */
  public void testLoginCaseReturnAllAttributesBySecDN() throws Exception {
    TAMDefaultLdapLoginModule lm = new TAMDefaultLdapLoginModule();
    lm.setApplicationContext(this.contextLoaderListener.getCurrentWebApplicationContext());
