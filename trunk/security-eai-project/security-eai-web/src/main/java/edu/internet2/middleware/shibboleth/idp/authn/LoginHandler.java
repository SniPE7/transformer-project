 ...
 * 
 * When a login handler is invoked the user's {@link group.tivoli.security.eai.web.auth.session.Session} is bound
 * to the {@link javax.servlet.http.HttpSession} under the attribute with the name
 * {@link group.tivoli.security.eai.web.auth.session.Session#HTTP_SESSION_BINDING_ATTRIBUTE}.
 * 
 ...
 * {@link group.tivoli.security.eai.web.auth.session.Session}.</li>
 ...
 * {@link javax.security.auth.Subject} within the {@link group.tivoli.security.eai.web.auth.session.Session}.</li>
 * </ul>
 * 
