 ...
 * 类（接口）继承、实现、功能等描述
 * @author zhangxianwen
 * @since 2012-6-28 下午3:36:31
 */

public class UserPassResetLdapLoginModuleTest extends TestCase {

  public UserPassResetLdapLoginModuleTest(String name) {
    super(name);
  }
  ...
  public void testNotPastReset() throws Exception {
    ...
    UserPassResetLdapLoginModule jaasLoginCtx = new UserPassResetLdapLoginModule();
  ...
  public void testPassReset() throws Exception {
  ...
  public class ApplicationContextBen implements ApplicationContext{
    ...
    public Object getBean(String name) throws BeansException {
      return new TimDBUserPassServiceImpl(){
        ...
        public boolean getPassResetState(String username) {
